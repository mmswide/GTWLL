...
class UIManager: NSObject {
    ...
    // Manages number of venues displayed per page on Venue List and Map view
    var pageSize = 76
    var mapsize = 76
    let preloadSize = 5
    ...
    let videoURL     = "http://res.cloudinary.com/hbab5hodz/video/upload/ac_none,br_64,c_scale,h_667,vc_auto,w_375/v1459521603/onboarding.mp4"
    ...
    let conciergeDesc  = "Connect with a Wellness Expert"
